...
.config(function($locationProvider, $urlRouterProvider, $stateProvider, $httpProvider, $qProvider,
  ...
  $stateProvider
    ...
    .state('image-editor', {
      url: '/image-editor/:id/:fileId',
      views: {
        'page': {
          templateUrl: 'partial/docs/image-editor.html',
...
angular.module('docs')
.controller('DocumentViewContent', ['$scope', '$rootScope', '$stateParams', 'Restangular', '$dialog', '$state', 'Upload', '$translate', '$uibModal', 'Notification', function($scope, $rootScope, $stateParams, Restangular, $dialog, $state, Upload, $translate, $uibModal, Notification) {
  // ... existing code ...
}])
.controller('ImageEditorController', ['$scope', '$stateParams', 'Restangular', '$translate', 'Notification', '$state', function($scope, $stateParams, Restangular, $translate, Notification, $state) {
  ...
  Restangular.one('file', $stateParams.fileId).get().then(function(file) {
    ...
    $scope.imageUrl = '../api/file/' + $stateParams.fileId + '/data';
...
.factory('Notification', ['$rootScope', function($rootScope) {
  return {
    success: function(message) {
      $rootScope.$broadcast('notification', { type: 'success', message: message });
    },
